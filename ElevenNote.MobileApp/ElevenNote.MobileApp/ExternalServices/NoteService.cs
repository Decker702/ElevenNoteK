...
{
    internal class NoteService //To handle all API Communication
    {
        public static string BearerToken { get; set; }
        private const string _apiUrl = "https://auri-efa-elevennoteapi-april2017.azurewebsites.net";//Holds API Url
